      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <Input
            ...
            disabled={isConnected}
          />
          <p className="text-sm mt-1 text-magical-secondary">
        ...
        {isConnected && (
          <div className="space-y-4">
            ...
            {testPageUrl && (
              <div className="p-4 rounded-lg space-y-2" style={{ background: 'rgba(251, 191, 36, 0.1)' }}>
                <p className="text-sm text-magical-secondary">Test page created successfully!</p>
                <a
                  href={testPageUrl}
                  target="_blank"
                ...
                <p className="text-xs text-magical-secondary">
