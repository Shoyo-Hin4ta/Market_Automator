...
import { groupDesignsByDimension, getDimensionLabel, DIMENSION_GROUPS } from '@/app/lib/utils/dimension-utils'
  ...
  if (designs.length === 0) {
    return (
      <div className="text-center py-12">
        <p style={{ color: '#fbbf24' }}>No designs found</p>
      </div>
    )
  }
          ...
          <div key={category} className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <h3 className="text-lg font-semibold" style={{ color: '#fcd34d' }}>
